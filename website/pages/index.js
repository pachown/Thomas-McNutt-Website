  ...
  return (
    <div className={Styles.container}>
      ...
      <main className={Styles.main}>
        ...
        <div className={Styles.section2}><article className={Styles.p2}>I love creating. Since I was young I've loved building new things and improving old things.</article></div>
